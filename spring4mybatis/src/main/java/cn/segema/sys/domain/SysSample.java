...
import cn.segema.frame.core.status.EnumSampleType;
import cn.segema.frame.core.status.EnumStatus;
...
public class SysSample implements Identifiable {
	 ...
	 */
	private EnumStatus sampleStatus;
	...
	public EnumStatus getSampleStatus() {
		return sampleStatus;
	}

	public void setSampleStatus(EnumStatus sampleStatus) {
