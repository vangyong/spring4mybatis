...
import cn.segema.system.status.EnumDictionaryType;
...
public class SysDictionary implements Identifiable {
	 ...
	 */
	private EnumActiveStatus dicStatus;
	...
	public EnumActiveStatus getDicStatus() {
		return dicStatus;
	}

	public void setDicStatus(EnumActiveStatus dicStatus) {
